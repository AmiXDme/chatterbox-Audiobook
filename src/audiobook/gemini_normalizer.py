...
CLOCK (:00=টা :15=সোয়া :30=সাড়ে :45=পৌনে; ১:৩০=দেড়টা; else HHটা MM). 24h folds to 12h.
  AM/PM pick daypart ভোর/সকাল/দুপুর/বিকাল/সন্ধ্যা/রাত from the TRUE hour (7 PM = সন্ধ্যা).
  Locative clock: ৭টা-এ -> সাতটায়; month+এ: সেপ্টেম্বর-এ -> সেপ্টেম্বরে, জানুয়ারি-এ -> জানুয়ারিতে.
